...
pub mod vault_manager {
    ...
    pub static VAULT_MANAGER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl ::core::fmt::Display for vault_managerEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::RebalanceBurnFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::RebalanceBurnResultFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::RebalanceMintFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::RebalanceMintResultFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetAllowedBrokerFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetAllowedChainTokenFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetAllowedSymbolFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetAllowedTokenFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetMaxWithdrawFeeFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
            }
        }
    ...
    #[ethcall(name = "setChain2cctpDomain", abi = "setChain2cctpDomain(uint256,uint32)")]
    ...
    impl ::ethers::core::abi::AbiDecode for vault_managerCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) = <AddBalanceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <FinishFrozenBalanceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FinishFrozenBalance(decoded));
            }
            if let Ok(decoded) = <FrozenBalanceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FrozenBalance(decoded));
            }
            if let Ok(decoded) = <GetAllAllowedBrokerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllAllowedBroker(decoded));
            }
            if let Ok(decoded) = <GetAllAllowedSymbolCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllAllowedSymbol(decoded));
            }
            if let Ok(decoded) = <GetAllAllowedTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllAllowedToken(decoded));
            }
            if let Ok(decoded) = <GetAllowedBrokerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllowedBroker(decoded));
            }
            if let Ok(decoded) = <GetAllowedChainTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllowedChainToken(decoded));
            }
            if let Ok(decoded) = <GetAllowedSymbolCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllowedSymbol(decoded));
            }
            if let Ok(decoded) = <GetAllowedTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <GetChain2VaultAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetChain2VaultAddress(decoded));
            }
            if let Ok(decoded) = <GetChain2CctpDomainCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetChain2CctpDomain(decoded));
            }
            if let Ok(decoded) = <GetFrozenBalanceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetFrozenBalance(decoded));
            }
            if let Ok(decoded) = <GetMaxWithdrawFeeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetMaxWithdrawFee(decoded));
            }
            if let Ok(decoded) = <GetRebalanceStatusCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RebalanceStatusCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetAllowedBrokerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetAllowedBroker(decoded));
            }
            if let Ok(decoded) = <SetAllowedChainTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetAllowedChainToken(decoded));
            }
            if let Ok(decoded) = <SetAllowedSymbolCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetAllowedSymbol(decoded));
            }
            if let Ok(decoded) = <SetAllowedTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetAllowedToken(decoded));
            }
            if let Ok(decoded) = <SetChain2VaultAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetChain2VaultAddress(decoded));
            }
            if let Ok(decoded) = <SetChain2CctpDomainCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetMaxWithdrawFeeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetMaxWithdrawFee(decoded));
            }
            if let Ok(decoded) = <SubBalanceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for vault_managerCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::GetAllowedBroker(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetAllowedChainToken(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetAllowedSymbol(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetAllowedToken(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::GetFrozenBalance(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::GetMaxWithdrawFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::RebalanceStatus(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::RenounceOwnership(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SetAllowedBroker(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SetAllowedChainToken(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SetAllowedSymbol(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SetAllowedToken(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::SetMaxWithdrawFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SubBalance(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
