...
use crate::db::hourly_gas_fee::{create_or_update_hourly_gas_fee, find_hourly_gas_fee, HourlyGasFee, HourlyGasFeeKey};
...
impl GasFeeContext {
    pub async fn get_hourly_gas(
        &mut self,
        p_key: &HourlyGasFeeKey,
    ) -> &mut HourlyGasFee {
