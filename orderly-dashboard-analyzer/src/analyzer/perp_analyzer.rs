...
pub async fn analyzer_perp_trade(
    ...
    for perp_trade in trades {
        ...
        tracing::info!(target:PERP_ANALYZER,"handle_perp_trade, pulled_block_height: {}, account_id: {}, symbol: {}, margin_mode: {:?}",pulled_block_height,perp_trade.account_id,perp_symbol,perp_trade.margin_mode);
