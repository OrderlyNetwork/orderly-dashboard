              ...
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex gap-[8px] items-center p-[16px] relative size-full flex-1">
                  {item.titleVariant === 'perps' ? (
                    <div className="basis-0 content-stretch flex gap-[16px] grow items-center min-h-px min-w-px relative shrink-0">
                      <div className="basis-0 content-stretch flex flex-col gap-[4px] grow items-start justify-center min-h-px min-w-px not-italic relative shrink-0">
                        <p
                          className="font-['Atyp_BL:Medium',sans-serif] font-medium leading-[1.6] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.98)] w-full"
                          style={{ letterSpacing: '0.042em' }}
                        >
                          I ♥ Perps Competition
                        </p>
                    ...
                    <div className="basis-0 content-stretch flex gap-[16px] grow items-center min-h-px min-w-px relative shrink-0">
                      <p
                        className="font-['Atyp_BL:Medium',sans-serif] font-medium leading-[1.6] h-full not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.5)] w-[256px]"
                        style={{ letterSpacing: '0.042em' }}
                      >
                  ...
                  {item.status === 'Ongoing' ? (
                    ...
                    >
                      <p className="font-['Atyp_BL:Medium',sans-serif] font-medium leading-[1.6] not-italic relative shrink-0 text-[10px] text-[rgba(255,255,255,0.98)] text-nowrap">
                        Ongoing
                      </p>
                    </div>
                  ) : (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="font-['Atyp_BL:Semibold',sans-serif] font-semibold text-[16px] leading-none not-italic text-white relative z-10"
          style={{ letterSpacing: '0.042em' }}
        >
          Campaigns
        </span>
    ...
    >
      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0">
        <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
          <p
            className="font-['Atyp_BL:Semibold',sans-serif] font-semibold leading-none not-italic relative shrink-0 text-[16px] text-center text-white"
            style={{ letterSpacing: '0.042em' }}
          >
            {label}
          </p>
