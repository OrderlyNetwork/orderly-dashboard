        ...
        <div className="px-[20px] py-[16px] flex flex-col gap-[6px]">
          {BUY_EXCHANGES.map((ex) => (
            <a
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(156,117,255,0.1)';
              }}
              onMouseLeave={(e) => {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ fontFamily: "'Atyp BL Text', 'Atyp BL', sans-serif", fontWeight: 600 }}
      >
    ...
    >
      <div className="content-stretch flex items-start relative shrink-0">
        <p
          ...
          style={{ fontFamily: "'Atyp BL Text', 'Atyp BL', sans-serif", fontWeight: 500 }}
        >
          {label}
        </p>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0">
      <p
        ...
        style={{ fontFamily: "'Atyp BL Text', 'Atyp BL', sans-serif", fontWeight: 700 }}
      >
        {title}
      </p>
      <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0">
...
function FooterSocialRow({ gap = 16 }: { gap?: number }) {
  ...
  const ICONS = [
    <svg key="discord" width="16" height="16" viewBox="0 0 24 24" fill="white">
...
export function TabletFooter() {
  ...
  return (
    <div style={{ width: '100%', paddingTop: 60 }}>
      {/* Purple card */}
      <div
        style={{ background: '#6700ce', borderRadius: 24, overflow: 'hidden', margin: '0 40px' }}
      >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {section.links.map((link) => (
                  <a
                    ...
                    rel={
                      link.external || link.target === '_blank' ? 'noopener noreferrer' : undefined
                    }
        ...
        >
          <div
            style={{
              ...
              alignItems: 'center',
              gap: 6,
              background: 'rgba(156,117,255,0.2)',
              borderRadius: 63,
              padding: '8px 12px'
            }}
          >
  ...
  return (
    <>
      <div style={{ width: '100%', paddingTop: 60 }}>
        {/* Purple card */}
        <div
          style={{ background: '#6700ce', borderRadius: 24, overflow: 'hidden', margin: '0 16px' }}
        >
          {/* ORDER logo + price + Buy ORDER pill */}
            ...
            {NAV_SECTIONS.map((section, i) => (
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderBottom:
                    i < NAV_SECTIONS.length - 1 ? '1px solid rgba(255,255,255,0.1)' : 'none',
                  cursor: 'pointer',
                  textAlign: 'left'
                }}
              >
